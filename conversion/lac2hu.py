...
parser = argparse.ArgumentParser(description='LAC to CT-HU')
...
parser.add_argument("--kvp", help="Integer that specify the kVp on CT scan (default =120)", const=120, type=int)
...
lac2hu(args.infile, args.outfile,kvp=args.kvp,mrac=args.mrac,verbose=args.verbose)