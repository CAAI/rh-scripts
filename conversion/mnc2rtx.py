#!/usr/bin/env python
import argparse
from rhscripts.conversion import mnc_to_rtx
...
"""Convert a minc file to dicom
    ...
    ----------
    minc_file : string
        Path to the minc file. Assume integer values of [0,1(,..)]
...
if not args.minc_file or not args.dicom_container or not args.dicom_output or not args.out_filename:
    parser.print_help()
    print('Too few arguments')
    exit(-1)

mnc_to_rtx( mncfile=args.minc_file,
